...
- Get [Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-adminlte-1759126962) via `eMail` and `Discord`
- Resources:
...
```bash
$ git clone https://github.com/django-adminlte-1759126962.git
$ cd django-adminlte-1759126962
```
